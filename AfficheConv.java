 ...
 * @author Niakulu
 */
public class AfficheConv extends javax.swing.JFrame {

    /**
     * Creates new form AfficheConv
     */
    public AfficheConv() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lb_titleConvention = new javax.swing.JLabel();
        lb_titleNumConv = new javax.swing.JLabel();
        ...
        lb_nomClientFromBdd = new javax.swing.JLabel();
        lb_descriptionMissionFromBdd = new javax.swing.JLabel();
        ...
        lb_titleConvention.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lb_titleConvention.setText("Convention numéro :");

        lb_titleNumConv.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lb_titleNumConv.setVisible(false);

        lb_Etudiant.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        lb_Etudiant.setText("Nom de l'étudiant :");
        ...
        lb_nomEtuFromBdd.setVisible(false);

        lb_nomClientFromBdd.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        lb_nomClientFromBdd.setVisible(false);

        lb_descriptionMissionFromBdd.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        lb_descriptionMissionFromBdd.setVisible(false);
        ...
        mainJPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainJPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(mainJPanelLayout.createSequentialGroup()
                        .addComponent(lb_titleConvention)
                        .addGap(160, 160, 160)
                        .addComponent(lb_titleNumConv))
                    .addGroup(mainJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addGroup(mainJPanelLayout.createSequentialGroup()
                            ...
                            .addComponent(lb_nomClientFromBdd))
                        .addGroup(mainJPanelLayout.createSequentialGroup()
                            .addComponent(lb_Etudiant)
                            .addGap(93, 93, 93)
                            .addComponent(lb_nomEtuFromBdd)))
                    .addGroup(mainJPanelLayout.createSequentialGroup()
                        .addComponent(lb_descriptionMission)
                        .addGap(114, 114, 114)
                        .addComponent(lb_descriptionMissionFromBdd, javax.swing.GroupLayout.PREFERRED_SIZE, 306, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(71, 118, Short.MAX_VALUE))
        );
        mainJPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainJPanelLayout.createSequentialGroup()
                ...
                .addGap(51, 51, 51)
                .addGroup(mainJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(lb_descriptionMissionFromBdd, javax.swing.GroupLayout.PREFERRED_SIZE, 162, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lb_descriptionMission))
...
int input = JOptionPane.showConfirmDialog(this, "Voulez vous quitter l'application ?", "", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AfficheConv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AfficheConv().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lb_descriptionMissionFromBdd;
    private javax.swing.JLabel lb_nomClientFromBdd;
    private javax.swing.JLabel lb_nomEtuFromBdd;
    private javax.swing.JLabel lb_titleConvention;
    private javax.swing.JLabel lb_titleNumConv;

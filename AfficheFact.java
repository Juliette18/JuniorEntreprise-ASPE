...
public class AfficheFact extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lb_titleFacture = new javax.swing.JLabel();
        lb_titleNumFacture = new javax.swing.JLabel();
        lb_numConv = new javax.swing.JLabel();
        lb_Client = new javax.swing.JLabel();
        lb_payee = new javax.swing.JLabel();
        lb_numConvFromBdd = new javax.swing.JLabel();
        lb_clientFromBdd = new javax.swing.JLabel();
        lb_paidFromBdd = new javax.swing.JLabel();
        ...
        lb_titleFacture.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lb_titleFacture.setText("Facture numéro :");

        lb_titleNumFacture.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        lb_titleNumFacture.setVisible(false);

        lb_numConv.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        lb_numConv.setText("Numéro de Convention :");

        lb_Client.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        lb_Client.setText("Nom Client :");

        lb_payee.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        lb_payee.setText("Payée :");

        lb_numConvFromBdd.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        lb_numConvFromBdd.setVisible(false);

        lb_clientFromBdd.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        lb_clientFromBdd.setVisible(false);

        lb_paidFromBdd.setFont(new java.awt.Font("Tahoma", 0, 13)); // NOI18N
        lb_paidFromBdd.setVisible(false);
            ...
            .addGroup(mainJPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(mainJPanelLayout.createSequentialGroup()
                        .addGroup(mainJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(mainJPanelLayout.createSequentialGroup()
                                .addComponent(lb_titleFacture)
                                .addGap(18, 18, 18)
                                .addComponent(lb_titleNumFacture, javax.swing.GroupLayout.PREFERRED_SIZE, 183, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(mainJPanelLayout.createSequentialGroup()
                                .addComponent(lb_payee)
                                .addGap(154, 154, 154)
                                .addComponent(lb_paidFromBdd, javax.swing.GroupLayout.PREFERRED_SIZE, 126, javax.swing.GroupLayout.PREFERRED_SIZE)))
                        .addContainerGap(261, Short.MAX_VALUE))
                    .addGroup(mainJPanelLayout.createSequentialGroup()
                        .addGroup(mainJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(lb_numConv)
                            .addComponent(lb_Client))
                        .addGap(58, 58, 58)
                        .addGroup(mainJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(lb_numConvFromBdd, javax.swing.GroupLayout.PREFERRED_SIZE, 148, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(mainJPanelLayout.createSequentialGroup()
                                .addComponent(lb_clientFromBdd, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGap(9, 9, 9))))))
        );
        mainJPanelLayout.setVerticalGroup(
            ...
            .addGroup(mainJPanelLayout.createSequentialGroup()
                ...
                .addGroup(mainJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lb_titleFacture)
                    .addComponent(lb_titleNumFacture))
                .addGap(42, 42, 42)
                .addGroup(mainJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lb_numConv)
                    .addComponent(lb_numConvFromBdd))
                .addGap(48, 48, 48)
                .addGroup(mainJPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lb_Client)
    ...
    private javax.swing.JLabel lb_numConv;
    private javax.swing.JLabel lb_numConvFromBdd;
    private javax.swing.JLabel lb_paidFromBdd;
    private javax.swing.JLabel lb_payee;
    private javax.swing.JLabel lb_titleFacture;
    private javax.swing.JLabel lb_titleNumFacture;

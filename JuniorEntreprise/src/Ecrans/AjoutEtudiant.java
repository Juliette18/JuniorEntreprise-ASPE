...
public class AjoutEtudiant extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pan_AjoutEtudiant = new javax.swing.JPanel();
        ...
        txt_NumTelEtu = new javax.swing.JTextField();
        ...
        pan_AjoutEtudiant.setBackground(new java.awt.Color(255, 255, 255));
        pan_AjoutEtudiant.setToolTipText("");
                ...
                .addGroup(pan_EtudiantLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(pan_EtudiantLayout.createSequentialGroup()
                        .addGroup(pan_EtudiantLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(txt_NumTelEtu, javax.swing.GroupLayout.DEFAULT_SIZE, 122, Short.MAX_VALUE))
        ...
        pan_EtudiantLayout.setVerticalGroup(
            ...
            .addGroup(pan_EtudiantLayout.createSequentialGroup()
                .addContainerGap()
                .addGroup(pan_EtudiantLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lb_Nom)
                ...
                .addGroup(pan_EtudiantLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lb_NumTelEtu)
                    .addComponent(txt_NumTelEtu, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(pan_EtudiantLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txt_MailEtu, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(lb_Mail))
                .addContainerGap(34, Short.MAX_VALUE))
        );

        bt_AjoutEtu.setText("Ajouter");
        bt_AjoutEtu.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bt_AjoutEtuActionPerformed(evt);
            }
        });

        javax.swing.GroupLayout pan_AjoutEtudiantLayout = new javax.swing.GroupLayout(pan_AjoutEtudiant);
        pan_AjoutEtudiant.setLayout(pan_AjoutEtudiantLayout);
    ...
    private void bt_AjoutEtuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bt_AjoutEtuActionPerformed
        String No = txt_Nom.getText();
        String P = txt_Prenom.getText();
        String N = txt_NumTelEtu.getText();
        String M = txt_MailEtu.getText();
        String regex = "[0-9]*";
        String emailRegex = "^[a-zA-Z0-9_+&*-]+(?:\\."+"[a-zA-Z0-9_+&*-]+)*@" +"(?:[a-zA-Z0-9-]+\\.)+[a-z" +"A-Z]{2,7}$";
        Pattern emailValide = Pattern.compile(emailRegex);
        //        String E = txt_Nom.getText();

        if (No.equals("")|| P.equals("")) {
    ...
    }//GEN-LAST:event_bt_AjoutEtuActionPerformed
    ...
    private javax.swing.JToggleButton bt_AjoutEtu;
    ...
    private javax.swing.JPanel pan_AjoutEtudiant;
    ...
    private javax.swing.JTextField txt_MailEtu;
    private javax.swing.JTextField txt_Nom;
    private javax.swing.JTextField txt_NumTelEtu;

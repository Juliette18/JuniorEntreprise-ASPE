 ...
 * @author Niakulu
 */
public class BrouillonFacture extends javax.swing.JFrame {

    /**
     * Creates new form Brouillonfacture
     */
    public BrouillonFacture() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Unagi - Brouillon de facture");
    ...
    private void cbb_etudiantsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbb_etudiantsActionPerformed
        ...
        if (choix.equals("Liste des étudiants")){
            ...
            try {
                ...
                Logger.getLogger(BrouillonFacture.class.getName()).log(Level.SEVERE, null, ex);
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BrouillonFacture.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BrouillonFacture().setVisible(true);
            }
        });
    }

 ...
 * @author Niakulu
 */
public class SMission_Cloturees extends javax.swing.JFrame {

    /**
     * Creates new form SMission_Cloturees
     */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SMission_Cloturees.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SMission_Cloturees().setVisible(true);
            }
        });
    }

 ...
 * @author Niakulu
 */
public class SMission_EnAttente extends javax.swing.JFrame {

    /**
     * Creates new form SMission_EnAttente
     */
    ...
    private void cbb_etudiants1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbb_etudiants1ActionPerformed
        ...
        if (choix.equals("Liste des étudiants")){
            ...
            try {
                ...
                Logger.getLogger(SMission_EnAttente.class.getName()).log(Level.SEVERE, null, ex);
            }
...
int input = JOptionPane.showConfirmDialog(this, "Voulez vous quitter l'application ?", "", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SMission_EnAttente.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SMission_EnAttente().setVisible(true);
            }
        });
    }
